...
public class VerifyUsers extends javax.swing.JFrame {
    ...
    public void getALLRecords (String email){
        ...
        while (itr.hasNext()){
            ...
            if(!userObj.getEmail().equals("Admin@gmail.com")){
                dtm.addRow(new Object[]{userObj.getId(),userObj.getName(),userObj.getEmail(),userObj.getMobileMumber(), userObj.getAddress(), userObj.getSecurityQuestion(), userObj.getStatus()});
    ...
    private void initComponents() {
        ...
        getContentPane().add(txtEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 80, 255, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(36, 127, 1300, 470));

        jLabel3.setFont(new java.awt.Font("Algerian", 0, 36)); // NOI18N
        jLabel3.setText(" *cLICK ON ROW TO CHANGE STATUS");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 630, -1, -1));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/watercolor-light-peach-background_ - Copy.png"))); // NOI18N
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1370, 730));
