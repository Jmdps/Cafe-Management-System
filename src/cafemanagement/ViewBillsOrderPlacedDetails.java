...
public class ViewBillsOrderPlacedDetails extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(246, 108, -1, -1));

        txtFilterDate.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        txtFilterDate.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtFilterDateKeyReleased(evt);
            }
        });
        getContentPane().add(txtFilterDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(359, 105, 250, -1));

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel4.setText("Change Order By ID: ");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(668, 108, -1, -1));
        ...
        getContentPane().add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(835, 105, 250, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(36, 226, 1295, 415));

        jLabel5.setFont(new java.awt.Font("Algerian", 1, 36)); // NOI18N
        jLabel5.setText("*Click on row to open");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(465, 659, -1, -1));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/watercolor-light-peach-background_ - Copy.png"))); // NOI18N
